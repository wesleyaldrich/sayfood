...
return [
    ...
    'csv_instruction_5' => '5. `category_name` harus salah satu dari: <strong>Hidangan Utama, Makanan Penutup, Minuman, Camilan</strong>.',
    'csv_instruction_6' => '6. `exp_datetime` harus mengikuti format: <strong>YYYY-MM-DD HH:MM:SS</strong> (contoh: 2025-12-31 23:59:00).',
    'csv_instruction_7' => '7. Kompres seluruh folder menjadi satu file <strong>.zip</strong>.',
