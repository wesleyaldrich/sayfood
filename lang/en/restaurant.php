...
return [
    ...
    'csv_instruction_5' => '5. The `category_name` must be one of the following: Main Course, Dessert, Drinks, Snacks.',
    'csv_instruction_6' => '6. The `exp_datetime` must follow the format: YYYY-MM-DD HH:MM:SS (e.g., 2025-12-31 23:59:00).',
    'csv_instruction_7' => '7. Compress the entire folder into a single .zip file.',
