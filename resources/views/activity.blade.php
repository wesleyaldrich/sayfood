                            ...
                            <div class="bg-white p-4 rounded-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('event_category_id') is-invalid @enderror"
                                        ...
                                        <option value="" disabled {{ old('event_category_id') ? '' : 'selected' }}>
                                            Select type</option>
                                        <option value="1" {{ old('event_category_id') == 1 ? 'selected' : '' }}>Cooking
                                            Workshop</option>
                                        <option value="2" {{ old('event_category_id') == 2 ? 'selected' : '' }}>Food
                                            Donation</option>
                                        <option value="3" {{ old('event_category_id') == 3 ? 'selected' : '' }}>Education
                                        </option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        min="1" />
                                    @error('estimated_participants') <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">WhatsApp Group Link</label>
                                    <input type="url" class="form-control @error('wa_link') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            <div class="bg-white p-4 rounded-3 mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('start_minute') <div class="text-danger">{{ $message }}</div> @enderror
