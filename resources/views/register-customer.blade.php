@extends('layout.auth')
@section('title', __('profile.customer_register_page_title'))
@section('content')
    <div class="auth-form-container d-flex align-items-center justify-content-center flex-column p-3" >
        ...
        <div class="container">
            <form action=" {{ route('register') }} " method="POST">
                ...
                <div class="form-group mb-2">
                    <label for="email" class="oswald">{{ __('profile.email_label') }}</label>
                ...
                <div class="form-group mb-2">
                    <label for="password_confirmation" class="oswald">{{ __('profile.confirm_password_label') }}</label>
            ...
            <div class="container d-flex justify-content-center mt-3">
                <p class="oswald m-0" style="font-weight: 400">{{ __('profile.already_have_account_question') }} <a href="{{ route('show.login') }}">{{ __('profile.login_link') }}</a></p>
            </div>
        </div>
    </div>
@endsection