...
<style>
    ...
    .details-card, .participants-card {
        ...
        overflow: hidden; /* Add this to prevent image overflow on border-radius */
    }
    .details-card .card-body, .participants-card .card-body {
        padding: 1.5rem;
    }
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-item">
                                ...
                                <div><strong>Creator</strong><br>
                                    {{ $event->creator->user->username ?? 'Creator Name' }} (ID: {{ $event->creator_id }})
                                </div>
                            </div>
                            <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div><strong>Group Link</strong><br>
                            @if($event->group_link)
                                <a href="{{ $event->group_link }}" target="_blank" rel="noopener noreferrer">{{ $event->group_link }}</a>
                            @else
