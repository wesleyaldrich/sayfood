    ...
    public function run(): void
    {
        $events = [
            [
                'id' => 1,
                'creator_id' => 1,
                'event_category_id' => 2, // Cooking Workshop
                ...
                'image_url' => 'assets/event_images/ev1.jpg', 'date' => '2025-06-20', 'location' => 'Ramurasa Cooking Studio, Kemang Jakarta Selatan', 'status' => 'On Going',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 2,
                'creator_id' => 2,
                'event_category_id' => 3, // Education
                ...
                'image_url' => 'assets/event_images/ev2.jpg', 'date' => '2025-07-09', 'location' => 'Pergudangan Elang Laut, Sentra Industri 1, Blok A5 No.6, Jakarta Utara', 'status' => 'Pending',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 3,
                ...
                'image_url' => 'assets/event_images/ev3.jpg', 'date' => '2025-07-03', 'location' => 'Jalan M.H. Thamrin No.28-30 RT.9/RW.5, Gondangdia, Menteng, Jakarta Pusat', 'status' => 'Coming Soon',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 4,
                ...
                'image_url' => 'assets/event_images/ev4.jpeg', 'date' => '2025-08-09', 'location' => 'Jl. Ciniru 7 No.23, Kebayoran Baru, Jakarta Selatan', 'status' => 'Canceled',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 5,
                ...
                'image_url' => 'assets/event_images/ev5.jpeg', 'date' => '2025-08-19', 'location' => 'Jl. Wijaya 2, Kebayoran, Jakarta Selatan', 'status' => 'Completed',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 6,
                ...
                'image_url' => 'assets/event_images/ev6.jpg', 'date' => '2025-09-02', 'location' => 'Jl. Tikukur No. 6, Gasibu, Sadang Serang, Coblong, Kota Bandung', 'status' => 'On Going',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 7,
                ...
                'image_url' => 'assets/event_images/ev7.jpg', 'date' => '2025-05-15', 'location' => 'Jl. Anggrek Garuda Blok J No.71 RT.6/RW.3, Kemanggisan, Palmerah, Jakarta Barat', 'status' => 'Coming Soon',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 8,
                ...
                'image_url' => 'assets/event_images/ev8.jpg', 'date' => '2025-06-27', 'location' => 'Jl. Nyuh Bulan, Banjar Nyuh Kuning, Mas, Ubud, Bali', 'status' => 'Pending',
                'created_at' => now(), 'updated_at' => now()
            ],
            [
                'id' => 9,
        ...
        foreach ($events as &$event) {
            $event['hour'] = rand(8, 20); // random jam 8 - 20
